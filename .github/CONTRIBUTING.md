...
4. Create a pull request by going to the branch in github (e.g. https://github.com/ucsdlib/hydra-demo-playbooks/tree/branchname/) and clicking on the pull request button (green arrows going in a circle). Make sure the PR can be merged automatically, if it can't go back to Step 3.
...
6. The entire `@ucsdlib/operations` team has an opportunity to review. At least
